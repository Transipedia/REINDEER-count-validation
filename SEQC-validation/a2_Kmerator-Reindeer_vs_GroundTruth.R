...
OUTDIR <- paste0(WKDIR, "Results/reindeer-kmerator2taqman/")
...
ggsave(plt_lst[[1]], filename = paste0(OUTDIR, "Fig1b_kmerator-reindeer.k31.mean.svg"),
       width = 5, height = 5)

ggsave((plt_lst[[1]] | plt_lst[[2]]) / (plt_lst[[3]] | plt_lst[[4]]),
       filename = paste0(OUTDIR, "SupplFig_kmerator-reindeer.k31.4metrics.svg"),
       width = 9, height = 5)
